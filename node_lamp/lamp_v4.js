/*
 *  first version with pixels obj for lamp
 */
...
function step_angle(angle){
  ...
  //   // stopped
  //   if(Math.random()<probab){
  //     angle.count = scale(Math.random(),0,1,20,100);
  //     angle.speed = expon(Math.random(),0,1,-maxSpeed,maxSpeed);
  //     console.log('  #R  ',angle);
  //   }
  //   else    console.log('.',t);
  // }
...
//   }
// }
function fade_around(bright,col){
  var r = Math.round(bright*col[0]);
  var g = Math.round(bright*col[1]);
  var b = Math.round(bright*col[2]);
  return [r,g,b];
}
