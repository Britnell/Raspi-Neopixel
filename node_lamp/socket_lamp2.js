/*
 *    First version running socket server and basic animations
 *	  web interface lets you chose RGB col of lamp
 *    only one color mode
 */
...
io.on('connection', (socket)=>{
  ...
  socket.on('lamp',(data)=>
  {
    ...
    {
      console.log(" sending colour ", colour);
      socket.emit('lamp',{'get-col': colour });
    }
  });
